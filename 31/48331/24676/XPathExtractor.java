 ...
 * <dt>//TemplateList</dt>
 *     <dd>extracts the XML fragment for TemplateList node.</dd>
 * <dt>//TemplateList/text()</dt>
 *     <dd>extracts the text content for TemplateList node.</dd>
 * </dl>
 */
            ...
            for (int i = 0 ; i < length; i++) {
                ...
                if ( match instanceof Element){
                   ...
                   */
                   ...
                   /*
                    CJR - Do this instead:  Returns whatever the XPath states, meaning
                    if the user uses //TemplateList the code returns the XML fragment for
                    TemplateList. If you want the text then specify the XPath as //TemplateList/text()
                    and the code will return the text content.
                   */
