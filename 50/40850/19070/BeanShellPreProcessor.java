...
public class BeanShellPreProcessor extends AbstractTestElement implements PreProcessor, Serializable, TestBean {
    ...
    public void process(){
        ...
        //cleans the environment (leaks otherwise)
        try {
			bshInterpreter.cleanup(); //this may clean some static stuff!
		} catch (JMeterException e) {
            log.warn("Problem in cleaning up BeanShell " + e);
		} 
        
        //throw out the interpreter
        bshInterpreter = null;
	}
