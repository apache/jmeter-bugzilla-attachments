// $Header: /home/cvs/jakarta-jmeter/src/core/org/apache/jmeter/control/WhileController.java,v 1.5 2005/07/12 20:51:00 mstover1 Exp $
/*
 ...
 */
public class WhileControllerCount extends GenericController implements Serializable {
	private static Logger log = LoggingManager.getLoggerForClass();

	private final static String CONDITION = "WhileController.condition"; // $NON-NLS-1$

    public static final String REFNAME = "WhileController.refname"; // added by me
	...
	private boolean endOfLoop(boolean loopEnd) {
        ...
        iLoopCount++;
        vars.put(refName, Integer.toString(iLoopCount));
    ...
    public void setRefName(String string) {
        log.debug("setRefName(" + string + ")");
		setProperty(new StringProperty(REFNAME, string));
	}

	public String getRefName() {
        String ref;
		ref = getPropertyAsString(REFNAME);
		log.debug("RefName() => " + ref);
		return ref;
    ...
    public static class Test extends JMeterTestCase {
		...
		public void runtestPrevOK(String type) throws Exception {
			...
			WhileControllerCount while_cont = new WhileControllerCount();
