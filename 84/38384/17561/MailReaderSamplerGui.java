...
public class MailReaderSamplerGui extends AbstractSamplerGui {
  ...
  private final static String ServerPortLabel = JMeterUtils.getResString("mail_reader_server_port");
  private final static String SecureLabel = JMeterUtils.getResString("mail_reader_secure");
  ...
  private int serverPort;
    ...
    serverPortField.setText(Integer.toString(mrs.getServerPort()));
    secureBox.setSelected(mrs.isSecure());
    ...
    mrs.setServerPort(serverPort);
    mrs.setSecure(secure);
    ...
    serverTypePanel.add(new JLabel(ServerPortLabel));
    serverPortField = new JTextField(5);
    serverPortField.setText(Integer.toString(0));
    serverPortField.addFocusListener(new FocusListener() {
    ...
    serverTypePanel.add(serverPortField);
    
    secureBox = new JCheckBox(SecureLabel, secure);
    secureBox.addItemListener(new ItemListener() {
