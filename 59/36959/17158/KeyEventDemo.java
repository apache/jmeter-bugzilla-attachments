...
public class KeyEventDemo extends JPanel 
    ...
    public KeyEventDemo() {
        ...
        add(createMenu(), BorderLayout.PAGE_END);
    }
    ...
    private JPopupMenu createMenu() {
    	...
    	String actionCommand = "copy";
    	JMenuItem item = new JMenuItem("copy label");
    	item.setVisible(true);
    	item.setName("name");
    	item.addActionListener(new Copy(displayArea));
		if (actionCommand != null) {
			item.setActionCommand(actionCommand);
		}
		// FIXME setting Ctrl+c doesn't work
		item.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_C, KeyEvent.CTRL_MASK));
		// TODO replacing with Ctrl+f works ?!
...
*/
    ...
    private class Copy extends AbstractAction {
		...
		public Copy(JTextArea displayArea) {
			this.displayArea = displayArea;
		}

    	public void actionPerformed(ActionEvent e) {
    		displayArea.setText("Copy - actionPerformed()");
    	}
    }
}
